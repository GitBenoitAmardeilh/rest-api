...
export const tryAddContent = createAction('[content] try add content', props<{table: ITable, data: {[key: string]: string}}>())
export const addContent = createAction('[content] add content')
